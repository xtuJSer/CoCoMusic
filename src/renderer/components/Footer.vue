<template>
  <div class="footer">
    <div class="play play-control-1">
      ...
      <a href="javascript:void(0);" v-show="!isPlay" @click="audio.play()">
        <img class="play-pause" src="../assets/img/play3.svg" alt=""> </a>
      <a href="javascript:void(0);" v-show="isPlay" @click="audio.pause()">
    ...
    <transition name="fade" mode="out-in">
      <div class="music" v-show="showLyric">
        <div class="music-info text-center">
          ...
          <br/> <br/>
          <button class="btn btn-sm" @click="favoriteSong">
            {{favorite ? '取消收藏' : '收藏'}}
            </button>
